  ...
  routes: [
    ...
    // App (auth-guarded)
    {
      ...
      children: [
        ...
        { path: 'staff', name: 'staff-list', component: () => import('../pages/staff/StaffListPage.vue'), meta: { roles: ['ADMIN', 'MANAGER'] } },
        ...
        { path: 'worker-stats', redirect: '/app/staff' },
        ...
        { path: 'order-list', name: 'order-list', component: () => import('../pages/documents/OrderListPage.vue'), meta: { roles: ['ADMIN', 'MANAGER', 'WORKER'] } },
        ...
        { path: 'documents/:id/edit', name: 'document-edit', component: () => import('../pages/documents/DocumentFormPage.vue'), meta: { roles: ['ADMIN', 'MANAGER', 'WORKER'] } },
